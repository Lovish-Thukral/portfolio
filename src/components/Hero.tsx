...
function Hero() {
  return (
    <div
      className="w-11/12 max-w-4xl text-center mx-auto min-h-[100dvh] flex flex-col items-center justify-center gap-3"
      id="home"
    >
      <motion.div
        initial={{ scale: 0.3 }}
      ...
      >
        The beauty of code isn’t in writing it, but in how little the next
        developer suffers reading it.
      </motion.p>
      <motion.div
        initial={{ y: 30, opacity: 0 }}
        whileInView={{ y: 0, opacity: 1 }}
